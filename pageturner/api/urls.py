...
urlpatterns = [
    ...
    path('personal_recs/', views.personal_recommendations, name="personal_recommendations"),
    path('friends_recs/', views.friends_recommendations, name="friends_recommendations"),
