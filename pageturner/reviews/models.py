...
class Author(models.Model):
    ...
    name = models.CharField(
        max_length=100, help_text="The name of the author", default=None
    )
...
class Book(models.Model):
    ...
    rating = models.FloatField(
        default=0, help_text="The rating of the book", null=True, blank=True
    )
    author = models.ForeignKey(Author, on_delete=models.CASCADE)
    url = models.URLField(
        help_text="Link to the book page on Goodreads", default=None, null=True
    )
    cover_url = models.URLField(null=True, blank=True)
    summary = models.CharField(
        max_length=5000, help_text="Summary of the book", blank=True, null=True
    )
    main_genre = models.CharField(
        max_length=20, help_text="Main genre of the book", blank=True, null=True
    )
    secondary_genre = models.CharField(
        max_length=50, help_text="Secondary genre of the book", blank=True, null=True
    )
    genres = models.CharField(
        max_length=1000, help_text="Genres of the book (tags)", null=True, blank=True
    )
    number_of_pages = models.IntegerField(
        help_text="Number of pages in the book", blank=True, null=True
    )
    time = models.CharField(
        max_length=30, help_text="Time to finish the book", blank=True, null=True
    )
    ...
    year = models.IntegerField(
        help_text="Release year of the book", blank=True, null=True
    )
    format_book = models.CharField(
        max_length=50, help_text="Format of the book", blank=True, null=True
    )
    language = models.CharField(
        max_length=50, help_text="Language of the book", blank=True, null=True
    )
    ...
    age = models.CharField(
        max_length=100, help_text="Age of book's audience", blank=True, null=True
    )
    main_age = models.CharField(
        max_length=20, help_text="Main age of the book", blank=True, null=True
    )
    ...
    part_of_series = models.CharField(
        max_length=200, help_text="Part of book series", blank=True, null=True
    )
...
class BookCollection(models.Model):
    ...
    books = models.ManyToManyField(
        Book, related_name="book_lists", help_text="Books in the list"
    )
...
class Review(models.Model):
    ...
    date_edited = models.DateTimeField(
        null=True, help_text="The date and time this review was last edited."
    )
    ...
    likes = models.ManyToManyField(
        User, related_name="review_like", blank=True, default=0
    )
...
class SharedReview(models.Model):
    original_review = models.ForeignKey(
        Review, on_delete=models.CASCADE, related_name="shared_review"
    )
...
class ReviewComment(models.Model):
    user = models.ForeignKey(
        User, related_name="review_comment", on_delete=models.CASCADE
    )
    body = models.CharField(max_length=300)
    created_at = models.DateTimeField(auto_now_add=True)
    review = models.ForeignKey(
        Review, on_delete=models.CASCADE, related_name="commented_review"
    )
